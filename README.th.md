...
<td width="40%" valign="middle">
<h3>SSH</h3>
<code>cmuxplus ssh user@remote</code> สร้างเวิร์กสเปซสำหรับเครื่องรีโมต แผงเบราว์เซอร์จะเชื่อมต่อผ่านเครือข่ายรีโมตเพื่อให้ localhost ใช้งานได้ทันที ลากรูปภาพเข้าสู่เซสชันรีโมตเพื่ออัปโหลดผ่าน scp
</td>
<td width="60%">
...
<code>cmuxplus claude-teams</code> รันโหมด teammate ของ Claude Code ด้วยคำสั่งเดียว สมาชิกทีมจะปรากฏเป็นแผงแบ่งแบบ native พร้อมข้อมูลเมตาในแถบด้านข้างและการแจ้งเตือน ไม่ต้องใช้ tmux
</td>
<td width="60%">
...
[ดาวน์โหลด CMUX+ NIGHTLY](https://github.com/tamekuniz/CMUX-Plus/releases/download/nightly/cmuxplus-nightly-macos.dmg)
...
- สร้างและมีส่วนร่วมใน [GitHub issues](https://github.com/tamekuniz/CMUX-Plus/issues) และ [discussions](https://github.com/tamekuniz/CMUX-Plus/discussions)
