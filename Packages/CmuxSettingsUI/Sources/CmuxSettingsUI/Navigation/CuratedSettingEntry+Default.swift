...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "active-pane-affordance", title: "Active Pane Affordance", synonyms: "paneAppearance.mode active focused pane affordance highlight border background foreground"),
            .init(section: .app, id: "active-pane-border-color", title: "Border color", synonyms: "paneAppearance.borderColor active focused pane border color highlight"),
            .init(section: .app, id: "active-pane-background-active", title: "Active background tint", synonyms: "paneAppearance.activeBackgroundColor active focused pane background tint color"),
            .init(section: .app, id: "active-pane-background-inactive", title: "Inactive background tint", synonyms: "paneAppearance.inactiveBackgroundColor inactive pane background tint color"),
            .init(section: .app, id: "active-pane-foreground-active", title: "Active foreground color", synonyms: "paneAppearance.activeForegroundColor active focused pane foreground text color"),
            .init(section: .app, id: "active-pane-foreground-inactive", title: "Inactive foreground color", synonyms: "paneAppearance.inactiveForegroundColor inactive pane foreground text color"),
