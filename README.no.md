...
<td width="40%" valign="middle">
<h3>SSH</h3>
<code>cmuxplus ssh user@remote</code> oppretter et arbeidsområde for en ekstern maskin. Nettleserpaneler rutes gjennom det eksterne nettverket, så localhost bare fungerer. Dra et bilde inn i en ekstern sesjon for å laste opp via scp.
</td>
<td width="60%">
...
<code>cmuxplus claude-teams</code> kjører Claude Codes lagkameratmodus med én kommando. Lagkamerater opprettes som native delinger med metadata i sidefeltet og varsler. Ingen tmux nødvendig.
</td>
<td width="60%">
...
[Last ned CMUX+ NIGHTLY](https://github.com/tamekuniz/CMUX-Plus/releases/download/nightly/cmuxplus-nightly-macos.dmg)
...
- Opprett og delta i [GitHub-issues](https://github.com/tamekuniz/CMUX-Plus/issues) og [diskusjoner](https://github.com/tamekuniz/CMUX-Plus/discussions)
