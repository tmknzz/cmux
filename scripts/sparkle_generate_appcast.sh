...
DOWNLOAD_URL_PREFIX="${DOWNLOAD_URL_PREFIX:-https://github.com/tamekuniz/CMUX-Plus/releases/download/$TAG/}"
RELEASE_NOTES_URL="${RELEASE_NOTES_URL:-https://github.com/tamekuniz/CMUX-Plus/releases/tag/$TAG}"
