...
APP="$HOME/Library/Developer/Xcode/DerivedData/cmux-${TAG_SLUG}/Build/Products/Debug/CMUX+ ${TAG}.app"
BID="com.cmuxplus.app.debug.${TAG_ID}"
SOCK="/tmp/cmux-debug-${TAG_SLUG}.sock"
DSOCK="$HOME/Library/Application Support/cmuxplus/cmuxd-dev-${TAG_SLUG}.sock"
...
sleep 0.5
pkill -f "CMUX\\+ ${TAG}.app/Contents/MacOS/cmuxplus DEV" || true
rm -f "$SOCK" "$DSOCK"
sleep 0.5
