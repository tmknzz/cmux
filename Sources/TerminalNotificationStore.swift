...
extension UNUserNotificationCenter {
    private static let removalQueue = DispatchQueue(
        label: "com.cmuxplus.notification-removal",
        qos: .utility
    )
...
enum NotificationSoundSettings {
    ...
    private static let customSoundPreparationQueue = DispatchQueue(
        label: "com.cmuxplus.notification-sound-preparation",
        qos: .utility
    )
    ...
    private static let customCommandQueue = DispatchQueue(
        label: "com.cmuxplus.notification-custom-command",
        qos: .utility
    )
...
final class TerminalNotificationStore: ObservableObject {
    ...
    static let categoryIdentifier = "com.cmuxplus.app.userNotification"
    static let actionShowIdentifier = "com.cmuxplus.app.userNotification.show"
