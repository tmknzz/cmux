...
enum SocketControlPasswordStore {
    ...
    private static let legacyKeychainService = "com.cmuxplus.app.socket-control"
...
struct SocketControlSettings {
    ...
    static let baseDebugBundleIdentifier = "com.cmuxplus.app.debug"
    ...
    static func defaultSocketPath(
        ...
        if bundleIdentifier == "com.cmuxplus.app.nightly" {
    ...
    static func isDebugLikeBundleIdentifier(_ bundleIdentifier: String?) -> Bool {
        ...
        return bundleIdentifier == "com.cmuxplus.app.debug"
            || bundleIdentifier.hasPrefix("com.cmuxplus.app.debug.")
    }

    /// Tagged DEV builds have bundle IDs like `com.cmuxplus.app.debug.<tag>`.
    ...
    static func isStagingBundleIdentifier(_ bundleIdentifier: String?) -> Bool {
        guard let bundleIdentifier else { return false }
        return bundleIdentifier == "com.cmuxplus.app.staging"
            || bundleIdentifier.hasPrefix("com.cmuxplus.app.staging.")
    }
