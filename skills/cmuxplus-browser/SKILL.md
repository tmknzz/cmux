---
name: cmuxplus-browser
description: End-user browser automation with CMUX+. Use when you need to open sites, interact with pages, wait for state changes, and extract data from cmuxplus browser surfaces.
---
...
```bash
cmuxplus --json browser open https://example.com
...
cmuxplus browser surface:7 fill e1 "hello"
cmuxplus --json browser surface:7 click e2 --snapshot-after
cmuxplus browser surface:7 snapshot --interactive
```
...
cmuxplus browser open https://example.com --workspace workspace:2 --window window:1 --json
```
...
cmuxplus browser <surface> wait --text "Success" --timeout-ms 10000
...
```bash
cmuxplus --json browser open https://example.com/signup
cmuxplus browser surface:7 get url
cmuxplus browser surface:7 wait --load-state complete --timeout-ms 15000
cmuxplus browser surface:7 snapshot --interactive
cmuxplus browser surface:7 fill e1 "Jane Doe"
cmuxplus browser surface:7 fill e2 "jane@example.com"
cmuxplus --json browser surface:7 click e3 --snapshot-after
cmuxplus browser surface:7 wait --url-contains "/welcome" --timeout-ms 15000
cmuxplus browser surface:7 snapshot --interactive
```
...
```bash
cmuxplus browser surface:7 fill e11 "" --snapshot-after --json
cmuxplus browser surface:7 get value e11 --json
```
...
cmuxplus browser surface:7 wait --load-state complete --timeout-ms 15000
cmuxplus browser surface:7 snapshot --interactive
cmuxplus --json browser surface:7 click e5 --snapshot-after
cmuxplus browser surface:7 snapshot --interactive
```
...
```bash
cmuxplus browser surface:7 get url
cmuxplus browser surface:7 get text body
cmuxplus browser surface:7 get html body
```
