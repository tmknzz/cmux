...
```bash
cmuxplus browser surface:7 snapshot
cmuxplus browser surface:7 snapshot --interactive
cmuxplus browser surface:7 snapshot --interactive --compact --max-depth 3
```

## Using Refs

```bash
cmuxplus browser surface:7 click e6
cmuxplus browser surface:7 fill e10 "user@example.com"
cmuxplus browser surface:7 fill e11 "password123"
cmuxplus browser surface:7 click e12
```
...
cmuxplus browser surface:7 click e1
...
```bash
cmuxplus browser surface:7 wait --selector "#target" --timeout-ms 10000
cmuxplus browser surface:7 scroll --dy 400
cmuxplus browser surface:7 snapshot --interactive
```
...
```bash
cmuxplus browser surface:7 snapshot --selector "form#checkout" --interactive
```
