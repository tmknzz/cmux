...
```bash
cmuxplus identify --workspace workspace:2
cmuxplus identify --workspace workspace:2 --surface surface:8
```
...
```bash
cmuxplus --json identify                 # refs-first output
cmuxplus --json --id-format both identify
cmuxplus --json --id-format uuids identify
```
