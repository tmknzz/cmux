...
# attention cue
cmuxplus trigger-flash --surface surface:7
```
...
| [../cmuxplus-browser/SKILL.md](../cmuxplus-browser/SKILL.md) | Browser automation on surface-backed webviews |
| [../cmuxplus-markdown/SKILL.md](../cmuxplus-markdown/SKILL.md) | Markdown viewer panel with live file watching |
