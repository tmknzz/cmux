...
# Absolute path
cmuxplus markdown open /path/to/PLAN.md

# Target a specific workspace
cmuxplus markdown open design.md --workspace workspace:2
```
...
cmuxplus markdown open plan.md --workspace workspace:2

# Open splitting from a specific surface
cmuxplus markdown open plan.md --surface surface:5

# Open in a specific window
cmuxplus markdown open plan.md --window window:1
```
