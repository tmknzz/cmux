...
```bash
skills/cmuxplus-debug-windows/scripts/debug_windows_snapshot.sh --copy
```
...
Examples:
```bash
skills/cmuxplus-debug-windows/scripts/debug_windows_snapshot.sh
skills/cmuxplus-debug-windows/scripts/debug_windows_snapshot.sh --copy
skills/cmuxplus-debug-windows/scripts/debug_windows_snapshot.sh --domain <bundle-id> --copy
```
